...
function MinimalTemplate({ sections, colors, targetRole }) {
  ...
  return (
    <div style={styles.page}>
      ...
      <div>
        ...
        {targetRole && (
          <p style={{ fontSize: '13px', color: colors.primary, marginTop: '2px', fontWeight: 500, letterSpacing: '1px', textTransform: 'uppercase' }}>
            {targetRole}
          </p>
        )}
