...
function ClassicTemplate({ sections, colors, targetRole }) {
  ...
  return (
    <div style={styles.page}>
      ...
      <div>
        ...
        <p style={{ textAlign: 'center', fontSize: '14px', fontWeight: 600, color: colors.accent, margin: '4px 0 0' }}>
          {targetRole || 'Professional Title'}
        </p>
