...
function CreativeTemplate({ sections, colors, targetRole }) {
  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.sectionGap}>
        ...
        {targetRole && (
          <p style={{ fontSize: '15px', fontWeight: 600, color: colors.accent, marginTop: '8px', textTransform: 'uppercase', letterSpacing: '1px' }}>
            {targetRole}
          </p>
        )}
