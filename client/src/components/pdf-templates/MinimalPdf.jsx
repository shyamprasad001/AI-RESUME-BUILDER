...
function MinimalPdf({ sections, colors, targetRole }) {
  ...
  return (
    <View style={styles.page}>
      ...
      <View>
        ...
        {targetRole && (
          <Text style={{ fontSize: 9, fontFamily: 'Helvetica-Bold', color: colors.primary, marginTop: 2, textTransform: 'uppercase', letterSpacing: 1 }}>
            {targetRole}
          </Text>
        )}
