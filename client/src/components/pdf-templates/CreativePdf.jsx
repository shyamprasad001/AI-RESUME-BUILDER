...
function CreativePdf({ sections, colors, targetRole }) {
  ...
  return (
    <View style={styles.page}>
      ...
      <View>
        ...
        {targetRole && (
          <Text style={{ fontSize: 11, fontFamily: 'Helvetica-Bold', color: colors.accent, marginTop: 4, textTransform: 'uppercase', letterSpacing: 1 }}>
            {targetRole}
          </Text>
        )}
